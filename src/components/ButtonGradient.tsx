...
interface ButtonGradientProps extends React.HTMLAttributes<HTMLElement> {
...
const ButtonGradient = (args: ButtonGradientProps) => {
  ...
  return (
    ...
    >
      <div
        className={cn(
          "w-auto text-white z-10 bg-slate-950 rounded-[inherit] flex items-center justify-center gap-2",
          className
        )}
      >
        {children}
